...
export function setupAuth(app: Express) {
  ...
  app.post("/api/login", (req, res, next) => {
    // err: Authentication error (if any)
    // user: Authenticated user object or false if authentication failed
    // info: Additional info object containing messages from strategy
